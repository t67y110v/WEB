...
const RestPage = (props : {name : string}) => {
    if (props.name == "") {
                ...
                <div className="col-8">
                    <div className="InputForm-form-container">
                        <div className='InputForm-form'>
                            ...
                            <h2 className="InputForm-form-title tx">Отправление сообщения о НР по REST</h2>
                            <br></br>
                                <div className="form-shadow">
                                    <Timeline active={1} bulletSize={34} lineWidth={5}>
                                        <Timeline.Item bullet={<IconGitBranch size={24} />} title="POST запрос на порт :8080">
